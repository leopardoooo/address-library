...
public class AdTreeUpload {
    /** 地址ID */
    private Integer addrId;

    /** 上传流水号 */
    private Integer uploadDoneCode;
    ...
    public Integer getUploadDoneCode() {
        return uploadDoneCode;
    }

    public void setUploadDoneCode(Integer uploadDoneCode) {
        this.uploadDoneCode = uploadDoneCode;
    }
